 ...
 */
#ifndef DRIVE_RECORDER_SER_HELPER_H
#define DRIVE_RECORDER_SER_HELPER_H
 ...
 * on a set of nodes.
 */
class ServerApplicationHelper
{
public:
  ServerApplicationHelper ();
  /**
   ...
   *
   */
  ServerApplicationHelper (std::string protocol, Address address);
...
#endif /* DRIVE_RECORDER_SER_HELPER_H */
